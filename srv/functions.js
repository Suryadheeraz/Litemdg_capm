...
async function createWorkflowCustomTaskUI(reqData, userEmail, creationTime, creationDate, req_no, Type_Request){
   let payload = {
    "definitionId": "eu10.bgsw-sdsc-coe-at1drpz8.customtaskuiprocess.customuiprocess",
    "context": {
        "changereqnumber": req_no.toString(),
            ...
            "Creation_Date": creationDate,
            "Creation_Time": creationTime,
            "Request_Status": "In-Progress - QualityManagement",           
            "Type_Request": Type_Request,
            "Description": reqData.Request_Desc,
            "currentstep": "Q1",
            "ApproverID" : "Kudumu.Ravi@in.bosch.com",
            "MaterialNumber" : reqData.MATNR || ""
    }
};
