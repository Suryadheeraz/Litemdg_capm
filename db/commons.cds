...
type ty_CharactValuation {
    CValuation_MARA_MATNR : String;
    CValuation_OBJEK      : String(40);
    CValuation_CLASS :  String;
    CValuation_KLART : String(3);
    ATNAM                 : String(30); // Characteristic Name
    ATZHL                 : Integer;
    ATWRT                 : String(70);
